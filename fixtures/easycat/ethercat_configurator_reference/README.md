...
This directory stores the paired EasyCAT project and generated reference artifacts for `examples/easycat-reference/device.yaml`.
...
3. If the generated XML/SII use input SyncManager address `0x1200`, keep them as known-bad evidence named:
