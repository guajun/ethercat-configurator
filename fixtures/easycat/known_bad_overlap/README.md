...
The checked-in generated artifacts were moved from the original `ethercat_configurator_reference` EasyCAT output without rewriting their generated contents. Regenerating from `known_bad_overlap.prj` should produce artifacts with matching internal EasyCAT project names.
